    ...
    return (
        <motion.div
            ...
            <motion.img
                ...
                className=' -mb-20 ml-4 flex-shrink-0 h-56 w-56 rounded-full object-cover md:h-95 md:w-64 md:rounded-lg md:mb-0 xl:h-42 xl:w-42' src='https://camo.githubusercontent.com/3fb12eff4f34c4a8a2680dae63b2337a4b6b1e831acaac47d9e21ad655c8480b/68747470733a2f2f692e67697068792e636f6d2f3369794b484d494b6735565747367148556d2e77656270' alt=''
            />
