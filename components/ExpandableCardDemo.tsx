                            ...
                            <div>
                                ...
                                <div className="pt-4 relative px-4">
                                    <motion.div
                                        ...
                                        animate={{ opacity: 1 }}
                                        exit={{ opacity: 0 }}
                                        className="text-neutral-600 text-xs md:text-sm lg:text-base h-40  pb-10 flex flex-col items-start gap-4 overflow-auto dark:text-neutral-400 [mask:linear-gradient(to_bottom,white,white,transparent)] [scrollbar-width:none] [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch]"
                                    >
...
const cards = [
    {
        ...
        title: "DeadPool",
        src: "https://static.wixstatic.com/media/5715ab_b7dbcc762b2a4172aecf06a467a07619~mv2.png",
        ctaText: "Visit",
        ctaLink: "https://static.wixstatic.com/media/5715ab_b7dbcc762b2a4172aecf06a467a07619~mv2.png",
        content: () => {
            return (
                <p>
